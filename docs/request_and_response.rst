...
.. note:: 示例中可以使用 ``ssp_token(32D4FAE475B19434FFC67983F6628A28)`` 、``Android测试 app_id（1000360）``、``iOS测试 app_id（1000748）`` 作为测试token获取测试数据，供测试查看效果使用，请正视上线后切换为正式配置，否则将不会产生任何请求，展示，点击收益等数据。
